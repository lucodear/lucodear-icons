...
- feat: added some folder names [`#3293`](https://github.com/lucodear/lucodear-icons/pull/3293)
- feat: apply folder-docs to diary and notes [`#3292`](https://github.com/lucodear/lucodear-icons/pull/3292)
- chore(deps): update dependency bun to v1.3.4 [`#3288`](https://github.com/lucodear/lucodear-icons/pull/3288)
- chore(deps): update actions/create-github-app-token action to v2.2.1 [`#3286`](https://github.com/lucodear/lucodear-icons/pull/3286)
- chore(deps): update github actions workflows [`#3281`](https://github.com/lucodear/lucodear-icons/pull/3281)
- feat: Add additional esbuild file patterns [`5801a121`](https://github.com/lucodear/lucodear-icons/commit/5801a121)
- fix: update Deno logo to new version [`#3278`](https://github.com/lucodear/lucodear-icons/pull/3278)
- feat: add salt file and folder icons [`#3275`](https://github.com/lucodear/lucodear-icons/pull/3275)
- feat: migrations folder [`#3187`](https://github.com/lucodear/lucodear-icons/pull/3187)
- feat: give Visual Studio icon to Solution Filter files [`#3272`](https://github.com/lucodear/lucodear-icons/pull/3272)
- chore(deps): update dependency bun to v1.3.3 [`#3267`](https://github.com/lucodear/lucodear-icons/pull/3267)
- chore(deps): update actions/create-github-app-token action to v2.2.0 [`#3268`](https://github.com/lucodear/lucodear-icons/pull/3268)
- chore(deps): update actions/checkout action to v6 [`#3266`](https://github.com/lucodear/lucodear-icons/pull/3266)
- chore(release): v5.29.0 [`ad930011`](https://github.com/lucodear/lucodear-icons/commit/ad930011)
- feat: add icon for Lean proof assistant language (.lean) [`#3256`](https://github.com/lucodear/lucodear-icons/pull/3256)
- feat: add feature folder icon [`#3260`](https://github.com/lucodear/lucodear-icons/pull/3260)
- chore(deps): update actions/checkout action to v5.0.1 [`#3263`](https://github.com/lucodear/lucodear-icons/pull/3263)
- feat: add 'cppm' file extension to cpp icon mapping [`4d4a9b6b`](https://github.com/lucodear/lucodear-icons/commit/4d4a9b6b)
- feat: update quarto icon SVG for improved resolution [`4785179e`](https://github.com/lucodear/lucodear-icons/commit/4785179e)
- feat: oxc for .oxlintrc.json and .oxfmtrc.json [`#3258`](https://github.com/lucodear/lucodear-icons/pull/3258)
- chore(deps): update dependency esbuild to ^0.27.0 [`#3255`](https://github.com/lucodear/lucodear-icons/pull/3255)
- chore(deps): update bun packages [`#3238`](https://github.com/lucodear/lucodear-icons/pull/3238)
- feat: add dedicated icons for license files [`#3239`](https://github.com/lucodear/lucodear-icons/pull/3239)
- chore(deps): update dependency bun to v1.3.2 [`#3254`](https://github.com/lucodear/lucodear-icons/pull/3254)
- feat(swift): extend Swift file icon mappings [`#3253`](https://github.com/lucodear/lucodear-icons/pull/3253)
- feat: add support for `vitest.unit.config` and `vitest.e2e.config` file patterns [`#3252`](https://github.com/lucodear/lucodear-icons/pull/3252)
- refactor: improve `certificate` icon design [`#3245`](https://github.com/lucodear/lucodear-icons/pull/3245)
- feat: add warp.md icon with light and dark theme [`#3244`](https://github.com/lucodear/lucodear-icons/pull/3244)
- feat: Image icon for KTX and KTX2 files [`#3246`](https://github.com/lucodear/lucodear-icons/pull/3246)
- feat: add lynx icon [`#3234`](https://github.com/lucodear/lucodear-icons/pull/3234)
- feat: apply `gemini-ai` icon to `GEMINI.md` file [`#3237`](https://github.com/lucodear/lucodear-icons/pull/3237)
- chore(deps): update dependency @biomejs/biome to v2.3.0 [`#3222`](https://github.com/lucodear/lucodear-icons/pull/3222)
- chore(deps): update dependency bun to v1.3.1 [`#3228`](https://github.com/lucodear/lucodear-icons/pull/3228)
- feat: add icon for licenses folder [`#3233`](https://github.com/lucodear/lucodear-icons/pull/3233)
- fix: Add 'jsonl' to languageIcons [`#3232`](https://github.com/lucodear/lucodear-icons/pull/3232)
- chore(release): v5.28.0 [`9ca2f188`](https://github.com/lucodear/lucodear-icons/commit/9ca2f188)
- feat: made the icon for `blog/` the same as `news/` [`#3231`](https://github.com/lucodear/lucodear-icons/pull/3231)
- feat: add Rstack (Rspack/Rsbuild/Rslib/Rspress/Rstest/Rslint) icons [`#3208`](https://github.com/lucodear/lucodear-icons/pull/3208)
- fix: add patch for changelogen@0.6.2 to tag contributors in release notes [`#3179`](https://github.com/lucodear/lucodear-icons/pull/3179)
- feat: eslint folder icons [`#3223`](https://github.com/lucodear/lucodear-icons/pull/3223)
- feat: input folder icon and simulations folder icon [`#3162`](https://github.com/lucodear/lucodear-icons/pull/3162)
- chore(deps): update dependency bun to v1.3.0 [`#3212`](https://github.com/lucodear/lucodear-icons/pull/3212)
- feat: add icon for ShellCheck rc files [`#3210`](https://github.com/lucodear/lucodear-icons/pull/3210)
- feat(icons): add chromatic icon [`#3217`](https://github.com/lucodear/lucodear-icons/pull/3217)
- feat: improve `console` icon design [`#3215`](https://github.com/lucodear/lucodear-icons/pull/3215)
- fix: remove unused bg from vala icon [`#3216`](https://github.com/lucodear/lucodear-icons/pull/3216)
- feat: add icons for cuelang [`#3211`](https://github.com/lucodear/lucodear-icons/pull/3211)
 
#### [v1.33.0](https://github.com/lucodear/lucodear-icons/compare/v1.32.0...v1.33.0) 

> October 10, 2025 

- release: 🔖 v1.33.0 [`9a8e5d3b`](https://github.com/lucodear/lucodear-icons/commit/9a8e5d3b)
...
- chore(deps): update dependency @biomejs/biome to v2.2.5 [`#3184`](https://github.com/lucodear/lucodear-icons/pull/3184)
- feat(icons): add happo icon [`#3199`](https://github.com/lucodear/lucodear-icons/pull/3199)
- chore(deps): update peter-evans/create-or-update-comment action to v5 [`#3201`](https://github.com/lucodear/lucodear-icons/pull/3201)
- chore(deps): update actions/stale action to v10.1.0 [`#3202`](https://github.com/lucodear/lucodear-icons/pull/3202)
- chore(deps): update bun packages to v20 (major) [`#3192`](https://github.com/lucodear/lucodear-icons/pull/3192)
- chore(deps): update dependency bun to v1.2.23 [`#3194`](https://github.com/lucodear/lucodear-icons/pull/3194)
- chore(deps): update peter-evans/find-comment action to v4 [`#3200`](https://github.com/lucodear/lucodear-icons/pull/3200)
- docs: fix translations path [`#3198`](https://github.com/lucodear/lucodear-icons/pull/3198)
- feat: use folder-svg icon for folder name 'vector' [`#3193`](https://github.com/lucodear/lucodear-icons/pull/3193)
- feat: add support for 'werf-includes' file extensions in icon mapping [`f380f35f`](https://github.com/lucodear/lucodear-icons/commit/f380f35f)
- feat(icons): add support for 'meson.options' file in meson icon mapping [`#3190`](https://github.com/lucodear/lucodear-icons/pull/3190)
- chore(deps): update dependency bun to v1.2.22 [`#3188`](https://github.com/lucodear/lucodear-icons/pull/3188)
- feat: add google icon [`#3181`](https://github.com/lucodear/lucodear-icons/pull/3181)
- feat: add `secret` file extension icon mapping [`#3189`](https://github.com/lucodear/lucodear-icons/pull/3189)
- chore(deps): update actions/create-github-app-token action to v2.1.4 [`#3185`](https://github.com/lucodear/lucodear-icons/pull/3185)
- feat(icons): add icon for toc (table of contents) [`#3140`](https://github.com/lucodear/lucodear-icons/pull/3140)
- chore(release): v5.27.0 [`52ad005a`](https://github.com/lucodear/lucodear-icons/commit/52ad005a)
- feat: add icons for Bashly files and folders [`#3174`](https://github.com/lucodear/lucodear-icons/pull/3174)
- chore(deps): update dependency @biomejs/biome to v2.2.3 [`#3119`](https://github.com/lucodear/lucodear-icons/pull/3119)
- feat: add new icons for opentofu [`#3177`](https://github.com/lucodear/lucodear-icons/pull/3177)
- feat: ✨ add nginx to language icons config [`#3178`](https://github.com/lucodear/lucodear-icons/pull/3178)
- refactor: update `console` icon for a pixel-perfect alignment [`#3175`](https://github.com/lucodear/lucodear-icons/pull/3175)
- chore(deps): update actions/labeler action to v6.0.1 [`#3170`](https://github.com/lucodear/lucodear-icons/pull/3170)
- feat: add onnx icon [`#3160`](https://github.com/lucodear/lucodear-icons/pull/3160)
- chore(deps): update actions/github-script action to v8 [`#3171`](https://github.com/lucodear/lucodear-icons/pull/3171)
- chore(deps): update github actions workflows (major) [`#3158`](https://github.com/lucodear/lucodear-icons/pull/3158)
- feat(icons): add icon for Verse programming language [`#3144`](https://github.com/lucodear/lucodear-icons/pull/3144)
- chore(deps): update dependency bun to v1.2.21 [`#3157`](https://github.com/lucodear/lucodear-icons/pull/3157)
- chore(gitignore): dedupe *.tgz and add .DS_Store [`#3168`](https://github.com/lucodear/lucodear-icons/pull/3168)
 
#### [v1.31.0](https://github.com/lucodear/lucodear-icons/compare/v1.30.0...v1.31.0) 

> September 2, 2025 

- release: 🔖 v1.31.0 [`5fdb3e72`](https://github.com/lucodear/lucodear-icons/commit/5fdb3e72)
...
- chore(deps): update dependency puppeteer to v24.15.0 [`#3107`](https://github.com/lucodear/lucodear-icons/pull/3107)
- chore(deps): update dependency typescript to v5.8.3 [`#3108`](https://github.com/lucodear/lucodear-icons/pull/3108)
- chore(deps): update dependency bun-types to v1.2.19 [`#3102`](https://github.com/lucodear/lucodear-icons/pull/3102)
- chore(deps): update dependency axios to v1.11.0 [`#3101`](https://github.com/lucodear/lucodear-icons/pull/3101)
- chore(deps): update commitlint monorepo to v19.8.1 [`#3100`](https://github.com/lucodear/lucodear-icons/pull/3100)
- chore(deps): update dependency husky to v9.1.7 [`#3099`](https://github.com/lucodear/lucodear-icons/pull/3099)
- chore(deps): update dependency esbuild to v0.25.8 [`#3098`](https://github.com/lucodear/lucodear-icons/pull/3098)
- chore(deps): bump tar-fs from 3.0.6 to 3.1.0 [`#3094`](https://github.com/lucodear/lucodear-icons/pull/3094)
- chore(deps-dev): bump form-data from 4.0.0 to 4.0.4 [`#3095`](https://github.com/lucodear/lucodear-icons/pull/3095)
- chore(deps): update changelogen to v0.6.2 [`dd2a18bb`](https://github.com/lucodear/lucodear-icons/commit/dd2a18bb)
- chore(deps): update dependency changelogen to v0.6.2 [`#3093`](https://github.com/lucodear/lucodear-icons/pull/3093)
- chore(deps): update dependency axios to v1.8.2 [security] [`#3092`](https://github.com/lucodear/lucodear-icons/pull/3092)
- chore(deps): update dependency @biomejs/biome to v2.1.3 [`#3091`](https://github.com/lucodear/lucodear-icons/pull/3091)
- feat(fileIcons): add .env.sentry-build-plugin to sentry icon [`#3090`](https://github.com/lucodear/lucodear-icons/pull/3090)
- feat: update readme with additional details [`dfa1071c`](https://github.com/lucodear/lucodear-icons/commit/dfa1071c)
- chore(deps): update dependency @softarc/sheriff-core to ^0.19.0 [`#3089`](https://github.com/lucodear/lucodear-icons/pull/3089)
- feat: added oxlintrc icon [`#3088`](https://github.com/lucodear/lucodear-icons/pull/3088)
- feat(fileIcons): add binary and engine-specific DB extensions [`#3086`](https://github.com/lucodear/lucodear-icons/pull/3086)
- chore(deps): update dependency bun to v1.2.19 [`#3083`](https://github.com/lucodear/lucodear-icons/pull/3083)
- chore(deps): update dependency @biomejs/biome to v2.1.2 [`#3082`](https://github.com/lucodear/lucodear-icons/pull/3082)
- feat: add helm language icon association [`#3081`](https://github.com/lucodear/lucodear-icons/pull/3081)
- feat: ✨ atomic design methodology folder icons [`#3075`](https://github.com/lucodear/lucodear-icons/pull/3075)
- fix: 🚑 wrong biome json schema in `biome.jsonc` [`#3074`](https://github.com/lucodear/lucodear-icons/pull/3074)
- feat: associate `folder-test` icon with `testfiles` folder [`#3072`](https://github.com/lucodear/lucodear-icons/pull/3072)
- chore(deps): update dependency @biomejs/biome to v2.1.1 [`#3071`](https://github.com/lucodear/lucodear-icons/pull/3071)
- fix: update markdown linting command in .lintstagedrc [`c628fdf2`](https://github.com/lucodear/lucodear-icons/commit/c628fdf2)
- chore: update contributor names in changelog with GitHub links [`f81dceaa`](https://github.com/lucodear/lucodear-icons/commit/f81dceaa)
- feat: add .qa-mincloudrc icon [`#3070`](https://github.com/lucodear/lucodear-icons/pull/3070)
- chore(deps): update dependency bun to v1.2.18 [`#3069`](https://github.com/lucodear/lucodear-icons/pull/3069)
- chore(deps): update bun packages (major) [`#3055`](https://github.com/lucodear/lucodear-icons/pull/3055)
- feat: associate `doctex-installer` icon with `.ins` file extension [`#3067`](https://github.com/lucodear/lucodear-icons/pull/3067)
- feat: associate `context` icon with `.ctx` file extension [`#3068`](https://github.com/lucodear/lucodear-icons/pull/3068)
 
#### [v1.27.0](https://github.com/lucodear/lucodear-icons/compare/v1.26.0...v1.27.0) 

> July 3, 2025 

- release: 🔖 v1.27.0 [`d68cbd7c`](https://github.com/lucodear/lucodear-icons/commit/d68cbd7c)
...
- chore(deps): update actions/stale action to v9.1.0 [`#2833`](https://github.com/lucodear/lucodear-icons/pull/2833)
...
- refactor: make use of clones for ngrx folder icons [`#2778`](https://github.com/lucodear/lucodear-icons/pull/2778)
...
- feat: ✨ illustrator script to import and resize icons [`6a4ba27b`](https://github.com/lucodear/lucodear-icons/commit/6a4ba27b)
...
- feat: ✨ pixel perfect lucodear typescript icons [`7f284950`](https://github.com/lucodear/lucodear-icons/commit/7f284950)
